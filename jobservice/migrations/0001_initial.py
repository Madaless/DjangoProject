# Generated by Django 2.2 on 2019-06-17 12:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nameCv', models.CharField(blank=True, default='cv', max_length=50)),
                ('lastName', models.CharField(blank=True, max_length=50)),
                ('firstName', models.CharField(blank=True, max_length=50)),
                ('dateOfBirth', models.CharField(blank=True, max_length=50)),
                ('education', models.TextField(blank=True, max_length=300)),
                ('placeOfResidence', models.TextField(blank=True, max_length=300)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('salary', models.CharField(blank=True, default='', max_length=10)),
                ('title', models.CharField(default='', max_length=50)),
                ('industry', models.CharField(blank=True, default='', max_length=50)),
                ('proffesion', models.CharField(blank=True, default='', max_length=50)),
                ('jobPosition', models.CharField(blank=True, default='', max_length=50)),
                ('jobType', models.CharField(blank=True, default='', max_length=50)),
                ('ExperienceLevel', models.CharField(blank=True, default='', max_length=50)),
                ('postdate', models.DateTimeField(default=django.utils.timezone.now)),
                ('location', models.CharField(default='', max_length=300)),
                ('jobDescription', models.TextField(blank=True, default='', max_length=300)),
            ],
        ),
        migrations.CreateModel(
            name='Company',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messForCompany', models.TextField(blank=True, default='', max_length=150)),
                ('link', models.TextField(blank=True, default='', max_length=150)),
        ...
        migrations.AddField(
            model_name='cv',
            name='person',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='jobservice.Person'),
        ),
    ]
